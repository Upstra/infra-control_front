...
<template>
  <div class="relative" ref="dropdownRef">
    ...
    <transition name="fade-slide">
      <div
        v-if="isOpen"
        class="absolute right-0 mt-2 w-56 bg-white border border-neutral-200 rounded-xl shadow-xl z-50 overflow-hidden">
        <ul class="text-sm text-neutral-800 divide-y divide-neutral-100">
          <li>
            <router-link
              to="/profile"
