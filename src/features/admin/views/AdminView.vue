...
<template>
  <div class="space-y-6 max-w-7xl mx-auto">
    <h1 class="text-3xl font-bold text-neutral-darker">{{ t('administration.section') }}</h1>
    <nav class="flex gap-6 border-b border-neutral-200 pb-2">
      <RouterLink
        ...
        :class="isActive(link.path) ? 'text-primary border-primary border-b-2' : 'text-neutral-500'"
      >
