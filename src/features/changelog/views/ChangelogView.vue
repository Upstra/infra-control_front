...
<template>
  <div class="mx-auto max-w-5xl py-10 px-2 sm:px-0 space-y-8">
    ...
    <div class="text-center space-y-4 mb-12">
      <div class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full text-sm font-medium text-blue-600 dark:text-blue-400 mb-4">
      ...
      <h1 class="text-5xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
        {{ $t('changelog.title') }}
      </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl p-6 border border-blue-200 dark:border-blue-800">
        <div class="flex items-center justify-between mb-2">
          ...
          <span class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ releases.frontend.length + releases.backend.length }}+</span>
        </div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">{{ $t('changelog.stats.releases') }}</p>
      </div>
      ...
      <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-2xl p-6 border border-purple-200 dark:border-purple-800">
        <div class="flex items-center justify-between mb-2">
          ...
          <span class="text-2xl font-bold text-purple-600 dark:text-purple-400">100+</span>
        </div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">{{ $t('changelog.stats.features') }}</p>
      </div>
      ...
      <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl p-6 border border-green-200 dark:border-green-800">
        <div class="flex items-center justify-between mb-2">
          ...
          <span class="text-2xl font-bold text-green-600 dark:text-green-400">500+</span>
        </div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">{{ $t('changelog.stats.bugFixes') }}</p>
      </div>
    </div>
    ...
    <!-- Releases Section -->
    <div class="relative">
      <div class="absolute -inset-4 bg-gradient-to-r from-blue-500/5 to-purple-500/5 rounded-3xl blur-2xl" />
      <div class="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-3xl border border-gray-200 dark:border-gray-800 shadow-xl p-8">
    ...
    <div v-if="error" class="text-red-500 text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
