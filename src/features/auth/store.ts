...
import { ref } from 'vue'
import type { LoginDto, RegisterDto, TwoFADto, AuthResponse, TwoFAResponseDto } from './types'
...
export const useAuthStore = defineStore('auth', () => {
  ...
  const verifyTwoFA = async (payload: TwoFADto) => {
    const storedToken =
      tempToken.value ?? localStorage.getItem('twoFactorToken') ?? localStorage.getItem('token')
