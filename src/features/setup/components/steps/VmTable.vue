<template>
  <table
    class="w-full mt-4 rounded-xl overflow-hidden border shadow-sm bg-white"
  >
    ...
    <tbody>
      <tr
        v-for="vm in vms"
        :key="vm.id"
        class="border-b last:border-0 hover:bg-neutral-50 group"
      >
        <td class="p-3 font-mono text-base text-neutral-darker">
          {{ vm.name }}
        </td>
