    ...
    <div class="flex flex-col items-center justify-center min-h-[70vh] px-4 py-10">
        <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-base md:text-lg text-neutral-dark max-w-lg mx-auto">
                Une <span class="font-semibold text-primary">salle</span> représente l'espace physique où sont hébergés
                vos serveurs.<br />
        ...
        <form @submit.prevent="handleSubmit"
            ...
            <div
                ...
                <span>
                    Cette salle sera votre salle <strong>par défaut</strong>. Vous pourrez créer d'autres salles depuis
                    le
...
const handleSubmit = async () => {
    try {
        ...
        setupStore.saveStepData(SetupStep.CREATE_ROOM, roomDataToSave);
