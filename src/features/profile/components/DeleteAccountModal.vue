...
<template>
  <transition name="fade">
    <div
      v-if="open"
      class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm dark:bg-neutral-900/50"
    >
      <div
        class="relative w-full max-w-md rounded-xl bg-white p-8 shadow-xl dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700"
        ...
        <form class="space-y-5" @submit.prevent="handleSubmit">
          <div>
            ...
            >
              ...
              <input
                ...
                @copy.prevent
                @cut.prevent
                class="w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary dark:bg-neutral-700 dark:border-neutral-600 dark:text-neutral-200"
                autocomplete="off"
          ...
          <div class="flex gap-4 justify-end pt-2">
            <button
              type="button"
              @click="emit('close')"
              class="px-4 py-2 rounded bg-neutral-100 text-neutral-700 hover:bg-neutral-200 transition dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-600 disabled:opacity-50 flex items-center gap-2"
            >
              {{ t('profile.cancel') }}
            </button>
            <button
              ...
              class="px-4 py-2 rounded bg-red-600 text-white font-bold hover:bg-red-700 transition disabled:opacity-50 flex items-center gap-2 dark:bg-red-500 dark:hover:bg-red-600 cursor-pointer"
            >
