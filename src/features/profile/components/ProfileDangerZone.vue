...
<template>
  <section
    class="bg-red-50 rounded-xl shadow p-6 border border-red-200 space-y-4"
  >
    ...
    <button
      ...
      class="px-4 py-2 rounded text-white bg-red-600 hover:bg-red-700 text-sm"
    >
