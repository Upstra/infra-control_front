...
<template>
  <section class="bg-white rounded-xl shadow p-6 border border-neutral-200 space-y-4">
    <h2 class="text-lg font-semibold text-neutral-darker mb-2 flex items-center gap-2">
    ...
    <div class="flex items-center justify-between">
      ...
      <button
        ...
        :class="props.user?.isTwoFactorEnabled ? 'bg-green-100 text-green-700 border-green-200 hover:bg-green-200' : 'bg-neutral-100 text-neutral-600 border-neutral-300 hover:bg-neutral-200'"
      >
