        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
            >
              <option :value="1">{{ $t('groups.priority1') }} - {{ $t('groups.priorityDesc1') }}</option>
              <option :value="2">{{ $t('groups.priority2') }} - {{ $t('groups.priorityDesc2') }}</option>
              <option :value="3">{{ $t('groups.priority3') }} - {{ $t('groups.priorityDesc3') }}</option>
              <option :value="4">{{ $t('groups.priority4') }} - {{ $t('groups.priorityDesc4') }}</option>
            </select>
          </div>
