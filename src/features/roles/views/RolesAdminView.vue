      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div v-if="loading" class="p-6">
              <div class="animate-pulse space-y-4">
                <div v-for="i in 4" :key="i" class="h-16 bg-gray-200 rounded-lg"></div>
              </div>
            </div>
            ...
            <div v-else class="divide-y divide-gray-200">
              <div
                ...
                :class="{ 'bg-blue-50 border-r-2 border-blue-500': selectedRole?.id === role.id }"
              >
                <div class="flex items-center justify-between">
                  <div class="flex-1">
            ...
            <div v-if="isMock && !loading" class="p-4 bg-yellow-50 border-t border-yellow-200">
        ...
        <div class="lg:col-span-2">
          <div v-if="selectedRole" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
              <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                  <div>
                    <div class="flex items-center space-x-3">
                      <h2 class="text-xl font-semibold text-gray-900">{{ selectedRole.name }}</h2>
                      <span
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div class="bg-blue-50 rounded-lg p-4">
                    <div class="flex items-center">
                      ...
                      <div class="ml-3">
                        ...
                        <p class="text-2xl font-bold text-blue-600">{{ selectedRole.userCount }}</p>
                      </div>
                    </div>
                  </div>
                  <div class="bg-green-50 rounded-lg p-4">
                    <div class="flex items-center">
                      ...
                      <div class="ml-3">
                        <p class="text-sm font-medium text-green-900">Active Users</p>
                  ...
                  <div class="bg-purple-50 rounded-lg p-4">
                    <div class="flex items-center">
                      ...
                      <div class="ml-3">
                        <p class="text-sm font-medium text-purple-900">Permissions</p>
                        <p class="text-2xl font-bold text-purple-600">{{ totalPermissions }}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div v-if="userLoading" class="p-6">
                <div class="animate-pulse space-y-4">
                  <div v-for="i in 3" :key="i" class="h-12 bg-gray-200 rounded-lg"></div>
                </div>
              </div>

              <div v-else-if="selectedRole.users.length === 0" class="p-6 text-center">
                <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                </svg>
                <h3 class="mt-2 text-sm font-medium text-gray-900">No users assigned</h3>
                <p class="mt-1 text-sm text-gray-500">Get started by assigning users to this role.</p>
              </div>
                ...
                >
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      :disabled="selectedRole.isAdmin && selectedRole.users.length <= 1"
                    >
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                      </svg>
          ...
          <div v-else class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <h3 class="mt-2 text-lg font-medium text-gray-900">Select a Role</h3>
            <p class="mt-1 text-sm text-gray-500">
              Choose a role from the left panel to view and manage its users and permissions.
            </p>
          </div>
        </div>
      </div>
...
const { rolesWithUsers, selectedRole, loading, userLoading, isMock } = storeToRefs(store);
...
const activeUsersCount = computed(() => {
  ...
  return selectedRole.value.users.filter(user => user.active).length;
});

const totalPermissions = computed(() => {
  if (!selectedRole.value) return 0;
  return selectedRole.value.permissionServers.length + selectedRole.value.permissionVms.length;
});
