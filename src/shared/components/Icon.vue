...
const sizeClass = computed(() => {
  ...
  if (sizeNum <= 16) return 'icon-sm';
  if (sizeNum >= 32) return 'icon-lg';
  return 'icon-md';
});
...
const paths: Record<string, string> = {
  ...
  battery:
    'M21 10V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2h14a2 2 0 002-2v-2zm0 0v4h1a1 1 0 001-1v-2a1 1 0 00-1-1h-1zM7 10h3m3 0h3',
  'check-circle': 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
  info: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
  memory:
    'M9 2v6h6V2M9 8h6v6H9V8zm0 6v6h6v-6M3 2v6h3V2H3zm0 6v6h3V8H3zm0 6v6h3v-6H3zm15-12v6h3V2h-3zm0 6v6h3V8h-3zm0 6v6h3v-6h-3z',
  'hard-drive': 'M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6',
  network: 'M13 17h8m0 0V9m0 8l-8-8-4 4-6-6',
  'trending-up': 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6',
  'trending-down': 'M13 17h8m0 0V9m0 8l-8-8-4 4-6-6',
  minus: 'M20 12H4',
  clock: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
  thermometer:
    'M9 16.17V10a3 3 0 0 1 6 0v6.17m-3-12.67a3 3 0 0 1 3 3v10a5 5 0 1 1-6 0V6.5a3 3 0 0 1 3-3z',
  calendar:
